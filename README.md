This is a clone/copy of the patched TinyGSM from M5Stack with support for SIM7028 for the ATOM DTU NB-IoT:     https://github.com/m5stack/TinyGSM/archive/refs/tags/v0.12.0-patch-1.zip

Copied here so it incase it got deleted from there. 
